...
raw_presets = [
    {
        ...
        "html": '<p>\r\n<div style="color:#e91e63;">{}</div>\r\n<div style="color:#3f51b5;">( Add your text to the address - YANDEX MAPS / Maps / Map / Presets > Text | Html )</div>\r\n</p>'.format(  # noqa: E501
            "Добавьте свой текст по адресу - ЯНДЕКС КАРТЫ / Карты / Карта /Пресеты / Text | Html",
        ),
        "js": "",
        "description": '<div style="color:#3F51B5;">{}.</div>\r\n<div style="color:#E91E63;">( Inserts text information - Link, advertisement, etc. )</div>'.format(  # noqa: E501
            "Вставляет текстовую информацию - Ссылка, реклама и т.д.",
        ),
        "slug": "text",
    },
    {
        ...
        "description": '<div style="color:#3F51B5;">{}\r\n{}</div>\r\n<div style="color:#E91E63;">( Accepts likes on geo-objects.  It works only in one selected place - Header, Description or Footer.)</div>'.format(  # noqa: E501
            "Принимает лайки на гео-объектах.",
            "Работает только в одном выбранном месте - Заголовок, Описание или Подвал.",
        ),
        "slug": "likes",
    },
]
