    ...
    for ymap in ymaps:
        ...
        if bool(re.search(r"Category", class_name)) or is_map:  # noqa: RUF055
            ...
            if editor.get("categories") is None:
                categories = {
                    "multiple": True,
                    "tabIcons": {"marker": "mdi-map-marker", "route": "mdi-routes", "territory": "mdi-beach"},
