...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        images = [
            '<p><img alt="" src="{}uploads/2019/12/29/1.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/2.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/3.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/4.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/5.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/6.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/7.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/8.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/9.jpg" style="width:322px;" /></p>'.format(media_url),
            '<p><img alt="" src="{}uploads/2019/12/29/10.jpg" style="width:322px;" /></p>'.format(media_url),
        ]
        ...
        for num in range(count):
            placemark = Placemark.objects.create(
                ...
                body="{}<p>{}</p>".format(images[random.randrange(count_images)], text[:1000]),
                footer="<p>Footer of Marker - {}</p>".format(next_number_marker),
                icon_slug=random.choice(icon_name_list),
                coordinates="[{},{}]".format(random.randrange(-84, 76), random.randrange(-170, 170)),
            )
            if count_subcategories > 0:
                placemark.subcategories.add(
                    *[
                        subcategories[idx]
                        for idx in random.sample(range(count_subcategories), random.randrange(count_subcategories) + 1)
                    ],
                )
