...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        null=True,
                        upload_to=djeym.utils.make_upload_path,
                        verbose_name="Icon",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="Example: Green Garden",
                        max_length=60,
                        unique=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="Examples: Offer accepted | The Offer is being processed | Offer completed",
                        max_length=60,
                        unique=True,
                        verbose_name="Status",
                    ),
            ...
            options={
                "verbose_name": "Geotag status",
                "verbose_name_plural": "Geotag statuses",
                "ordering": ("-status", "-id"),
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="Example: Сherry Light Amber",
                        max_length=60,
                        unique=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("svg", models.FileField(null=True, upload_to=djeym.utils.make_upload_path, verbose_name="Icon")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "screenshot",
                    models.ImageField(
                        help_text="Recommended size - Width=360 x Height=180",
                        null=True,
                        upload_to=djeym.utils.make_upload_path,
                        validators=[djeym.utils.validate_image],
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        default="",
                        help_text="API key or access_token",
                        max_length=255,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Examples: Supermarkets of the city of Kharkov | Luxury hotels in Honolulu | Parking of primitive people",
                        max_length=60,
                        unique=True,
                        verbose_name="Title",
                    ),
                ...
                (
                    "load_indicator_size",
                    models.PositiveSmallIntegerField(
                        choices=[(64, "64"), (96, "96"), (128, "128")],
                        default=64,
                        editable=False,
                        verbose_name="Load indicator size",
                    ),
                ),
                (
                    "animation_speed",
                    models.CharField(
                        ...
                        editable=False,
                        max_length=255,
                        verbose_name="Load indicator animation speed",
                    ),
                ),
                (
                    "disable_indicator_animation",
                    models.BooleanField(
                        default=False,
                        editable=False,
                        help_text="It may be useful for the abbreviation or logo of the company, if it does not make sense to animate them.",
                        verbose_name="Disable loading indicator animation",
                    ),
                ),
                ("slug", models.SlugField(blank=True, max_length=255, null=True, unique=True)),
                ...
                (
                    ...
                    models.CharField(
                        default="0",
                        help_text="Latitude center of the map.",
                        max_length=255,
                        validators=[djeym.utils.validate_coordinates],
                ...
                (
                    ...
                    models.CharField(
                        default="0",
                        help_text="Longitude center of the map.",
                        max_length=255,
                        validators=[djeym.utils.validate_coordinates],
                ...
                (
                    ...
                    models.BooleanField(
                        ...
                        default=True,
                        editable=False,
                        verbose_name="Add one-time categories",
                    ),
                ),
                (
                    "icon_cluster",
                    models.ForeignKey(
                        ...
                        related_name="ymap",
                        to="djeym.clustericon",
                        verbose_name="Icon for cluster",
                    ),
                ),
                (
                    "icon_collection",
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="ymap",
                        to="djeym.iconcollection",
                        verbose_name="Icon collection for markers",
                    ),
                ),
                (
                    "load_indicator",
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        blank=True,
                        default=0,
                        help_text="Examples: Average property value on a district site or Number of cameras installed on a building, etc.",
                        verbose_name="Weight",
                    ),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default='{"type": "Feature", "id": 0, "geometry": {"type": "Point", "coordinates": []}, "properties": {"weight": 0}}',
                        editable=False,
                        verbose_name="JSON",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Enable - Disperse points on higher zoom levels according to radius. Disable - Don't disperse.",
                        verbose_name="Disperse points",
                    ),
                ),
                (
                    "opacity",
                    models.CharField(
                        ...
                        default="0.8",
                        max_length=255,
                        validators=[djeym.utils.validate_transparency],
                        verbose_name="Transparency of heat layer",
                    ),
                ),
                (
                    "intensity",
                    models.CharField(
                        ...
                        max_length=255,
                        validators=[djeym.utils.validate_transparency],
                        verbose_name="Intensity of median point",
                    ),
                ),
                (
                    "gradient_color1",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cluster_layout",
                    models.CharField(
                        choices=[("cluster#balloonTwoColumns", "Two Columns"), ("cluster#balloonCarousel", "Carousel")],
                        default="cluster#balloonTwoColumns",
                        max_length=255,
                        verbose_name="Layout for the cluster information window",
                    ),
                ),
                (
                    "cluster_icon_content",
                    models.BooleanField(default=True, verbose_name="Display the number of objects in the cluster icon"),
                ),
                (
                ...
                (
                    ...
                    colorful.fields.RGBColorField(
                        ...
                        default="#43A047",
                        verbose_name="Color of controls",
                    ),
                ),
                (
                    "buttons_text_color",
                    colorful.fields.RGBColorField(
                        ...
                        default="#FFFFFF",
                        verbose_name="Text color on buttons",
                    ),
                ),
                (
                    "theme_type",
                    models.CharField(
                        ...
                        default="light",
                        max_length=255,
                        verbose_name="Theme type - light | dark",
                    ),
                ),
                ...
                (
                    "width_panel_editor",
                    models.PositiveSmallIntegerField(default=380, verbose_name="Width for panel of editor"),
                ),
                (
                    "width_panel_front",
                    models.PositiveSmallIntegerField(default=380, verbose_name="Width for panel of front"),
                ),
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        null=True,
                        upload_to=djeym.utils.make_upload_path,
                        verbose_name="Background image for the site panel",
                    ),
                ),
                (
                    "tinting_panel_front",
                    models.CharField(
                        default="#00000000",
                        max_length=9,
                        verbose_name="Background under controls of panel",
                    ),
                ),
                (
                    "hide_group_name_panel_front",
                    models.BooleanField(default=False, verbose_name="Hide group names (Categories, Subcategories)"),
                ),
                (
                    "width_map_front",
                    models.CharField(default="100%", max_length=255, verbose_name="Width of Map for Front page"),
                ),
                (
                    "height_map_front",
                    models.CharField(default="600px", max_length=255, verbose_name="Height of Map for Front page"),
                ),
                (
                    "ymap",
                    models.OneToOneField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Examples: Tourist routes or Marathon routes etc.",
                        max_length=60,
                        verbose_name="Title",
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="http://materialdesignicons.com/ - Example: help OR mdi-help",
                        max_length=255,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="The name of the aggregate of any geographic area. Examples: Honduran cities or Hawaiian beaches or Residential complexes in Antarctica.",
                        max_length=60,
                        verbose_name="Title",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Name of any geographic area - Country Name or City Name or District Name or The name of the resort coast, etc.",
                        max_length=60,
                        verbose_name="Title",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(default="", help_text="Example: Airport", max_length=60, verbose_name="Icon name"),
                ),
                ("size_width", models.PositiveSmallIntegerField(default=0, verbose_name="Icon width")),
                ("size_height", models.PositiveSmallIntegerField(default=0, verbose_name="Icon height")),
                (
                    ...
                    models.DecimalField(
                        decimal_places=1,
                        default=Decimal("0.0"),
                        help_text="Left, right - First time is automatically calculated.",
                        max_digits=3,
                        verbose_name="Offset by axis - X",
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=1,
                        default=Decimal("0.0"),
                        help_text="Up, down - First time is automatically calculated.",
                        max_digits=3,
                        verbose_name="Offset by axis - Y",
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="If the project uses 2-3 icons, it makes sense to disable the rest to optimize the download.",
                        verbose_name="Active icon ?",
                    ),
                ),
                ("slug", models.SlugField(blank=True, max_length=255, null=True)),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        ...
                        help_text="Brief description of the preset.",
                ...
                (
                    "autobody",
                    models.BooleanField(default=False, verbose_name="Automatically add to end of description"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Subcategory - This is a characteristic feature that markers have. Examples: Parking or Bicycle Parking or ATM or Cafe or Wi-Fi or Playground, etc.",
                        max_length=60,
                        verbose_name="Title",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    ckeditor_uploader.fields.RichTextUploadingField(
                        blank=True,
                        default="",
                        verbose_name="Description of the geo object",
                    ),
                ),
                (
                    "footer",
                    ckeditor_uploader.fields.RichTextUploadingField(blank=True, default="", verbose_name="Footer"),
                ),
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default='{"type": "Feature", "id": 0, "geometry": {"type": "LineString", "coordinates": []}, "properties": {"id": 0, "categoryID": 0, "subCategoryIDs": []}, "options": {"strokeWidth": 5, "strokeColor": "#00c853", "strokeStyle": "solid", "strokeOpacity": 0.9}}',
                        editable=False,
                        verbose_name="JSON",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        default='{"type": "Feature", "id": 0, "geometry": {"type": "Polygon", "coordinates": []}, "properties": {"id": 0, "categoryID": 0, "subCategoryIDs": []}, "options": {"strokeWidth": 2, "strokeColor": "#00c853", "strokeStyle": "solid", "strokeOpacity": 0.9, "fillColor": "#00E676", "fillOpacity": 0.9}}',
                        editable=False,
                        verbose_name="JSON",
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        blank=True,
                        editable=False,
                        help_text="Image from the user to description the geo-object (width = 966px, quality = 40).",
                        null=True,
                        upload_to=djeym.utils.make_upload_path,
                        verbose_name="Image from user",
                    ),
                ),
                (
                    "footer",
                ...
                ("icon_slug", models.SlugField(max_length=255, null=True, verbose_name="Иконка (slug)")),
                ("coordinates", models.CharField(default="[0,0]", max_length=255, verbose_name="Coordinates")),
                ("like", models.PositiveIntegerField(blank=True, default=0, verbose_name="Like")),
                ("dislike", models.PositiveIntegerField(blank=True, default=0, verbose_name="Dislike")),
                ...
                (
                    ...
                    models.EmailField(
                        blank=True,
                        help_text="To automatically send a one-time message if the user's geotag has been moderated and activated.",
                        max_length=254,
                        null=True,
                ...
                (
                    ...
                    models.GenericIPAddressField(
                        blank=True,
                        help_text="Ban user if vandalism is to be prevented.",
                        null=True,
                        verbose_name="User IP",
                    ),
                ),
                ("is_user_geotag", models.BooleanField(default=False, verbose_name="Is user's geotag ?")),
                (
                    "json_code",
                    models.TextField(
                        blank=True,
                        default='{"type": "Feature", "id": 0, "geometry": {"type": "Point", "coordinates": []}, "properties": {"id": 0, "categoryID": 0, "subCategoryIDs": [], "iconSlug": ""}, "options": {"iconLayout": "default#image", "iconImageHref": "", "iconImageSize": [], "iconImageOffset": []}}',
                        editable=False,
                        verbose_name="JSON",
                    ),
                ),
                ...
                ("is_created", models.BooleanField(default=False, editable=False, verbose_name="Is created ?")),
                (
                    "is_sended_admin_email",
                    models.BooleanField(default=False, editable=False, verbose_name="Is sent to admin by email ?"),
                ),
                (
                    "is_sended_user_email",
                    models.BooleanField(default=False, editable=False, verbose_name="Is sended user email ?"),
                ),
                (
                    "category",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Subcategory - This is a characteristic feature that the territories have.",
                        max_length=60,
                        verbose_name="Title",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Subcategory - This is a characteristic feature that routes have.",
                        max_length=60,
                        verbose_name="Title",
                    ),
                ),
