...
.. image:: https://img.shields.io/badge/version-1.2.5%20beta-brightgreen.svg
   :target: https://pypi.org/project/django-editor-ymaps/
   :alt: Version
...
.. attention::
   ...
   **Обратите внимание на раздел -** `Выводим карту на страницу сайта. <https://pypi.org/project/django-editor-ymaps/#id31>`_ **Добавлены минимизированные файлы (.min.)**.
