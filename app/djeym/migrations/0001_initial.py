...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        validators=[djeym.utils.validate_svg],
                        verbose_name="Icon",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="Example: Drop Light Peach",
                        max_length=60,
                        unique=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="",
                        help_text="https://materialdesignicons.com/ - Example: help",
                        max_length=255,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("header", models.CharField(default="", verbose_name="Route name")),
                (
                    "image_geo_object",
                    models.ImageField(
                        blank=True,
                        null=True,
                        upload_to=djeym.utils.make_upload_path,
                        validators=[djeym.utils.validate_image_geo_object],
                        verbose_name="Image of geo object",
                    ),
                ),
                ("footer", models.CharField(blank=True, default="", verbose_name="Footer")),
            ...
            bases=(models.Model, djeym.mixins.ResizeImageMixin),
        ),
        migrations.CreateModel(
            name="Polygon",
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("header", models.CharField(default="", verbose_name="Territory name")),
                (
                    "image_geo_object",
                    models.ImageField(
                        blank=True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name="ID")),
                ("header", models.CharField(default="", verbose_name="Place name")),
                (
                    "image_geo_object",
                    models.ImageField(
                        blank=True,
