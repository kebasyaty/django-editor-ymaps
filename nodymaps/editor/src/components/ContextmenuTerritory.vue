  ...
  <v-conteiner fluid>
    ...
    <v-row align="center" justify="center">
      <v-col cols="12" class="pt-0">
        <v-card-subtitle class="font-italic py-0">{{ $t('message.127') }}</v-card-subtitle>
        <v-divider></v-divider>
      </v-col>
      <!-- Color -->
    ...
    <v-row align="center" justify="center">
      <v-col cols="12" class="pt-0">
        <v-card-subtitle class="font-italic pt-2 pb-0">{{ $t('message.128') }}</v-card-subtitle>
        <v-divider></v-divider>
      </v-col>
      <!-- Color -->
      <v-col cols="12" class="text-center py-0">
...
export default {
    ...
    openDialog (index) {
      ...
      switch (index) {
        ...
        case 2:
          ...
          this.setDataAction({
            geoType: 'polygon',
            position: ['headerTerritory', 'bodyTerritory', 'footerTerritory'][index]
          })
  ...
  created () {
    ...
    if (this.editableGeoObject === null) {
      ...
      this.setStrokeStyle(this.strokeStyleList.filter(style => style.value === valStyle)[0])
      this.setStrokeWidth(this.editableGeoObject.options.get('strokeWidth'))
      this.setStrokeOpacity(this.editableGeoObject.options.get('strokeOpacity'))
