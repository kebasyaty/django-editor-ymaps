...
urlpatterns = [
    ...
    path("ajax-update-preset-settings/", views.AjaxUpdatePresetSettings.as_view(), name="ajax_update_preset_settings"),
    path(
    ...
    path("ajax-block-ip-address/", views.AjaxBlockIPAddress.as_view(), name="ajax_block_ip_address"),
