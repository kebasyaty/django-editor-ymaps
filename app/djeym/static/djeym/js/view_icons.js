...
$(document).ready(function () {
  ...
  if ($("form").is("#map_form")) {
    ...
    $(document).on("keyup mouseup mouseout", textObjs, function () {
      ...
      if ($this.val().length > 0) {
        $this
          .parent()
          .find(".view_icon")
          .html('<span class="mdi mdi-' + $this.val() + '"></span>');
      }
    });
    ...
    */
    ...
    if (
      $("#id_icon_cluster option:selected").val().length === 0 ||
    ...
    $iconCluster
      .parent()
      .addClass("custom_cluster_icon_wrapper")
      .append('<img src="" id="id_custom_cluster_icon" alt="Cluster Icon">');
    ...
    $iconCollection
      .parent()
      .addClass("icon_collection_wrapper")
      .append(
