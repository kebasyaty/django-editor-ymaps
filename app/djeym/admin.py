...
class TileSourceAdmin(admin.ModelAdmin):
    ...
    class Media:
        ...
        js = ["/static/djeym/js/jquery.min.js", "/static/djeym/js/import_export.min.js"]
...
class StatisticsAdmin(admin.ModelAdmin):
    ...
    class Media:
        css = {"all": ["/static/djeym/css/djeym_admin.min.css"]}
...
class MapAdmin(NonSortableParentAdmin):
    ...
    class Media:
        ...
        js = ["/static/djeym/js/jquery.min.js", "/static/djeym/js/admin_view_icons.min.js"]
...
class ClusterIconAdmin(admin.ModelAdmin):
    ...
    class Media:
        ...
        js = ["/static/djeym/js/jquery.min.js", "/static/djeym/js/get_icon_name.min.js"]
...
class IconCollectionAdmin(admin.ModelAdmin):
    ...
    list_display = ("title", "admin_thumbnail", "get_export_file_btn", "get_icon_count", "get_count_of_active_icons")
    list_display_links = ("title", "admin_thumbnail")
    readonly_fields = ("slug",)
...
class MarkerIconAdmin(admin.ModelAdmin):
    ...
    list_display = ("title", "admin_thumbnail", "get_collection_name", "active", "slug")
    list_display_links = ("title", "admin_thumbnail")
