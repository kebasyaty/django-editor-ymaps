...
raw_presets = [
    {
        ...
        "js": "",
        "description": '<div style="color:#3F51B5;">{}.</div>\r\n<div style="color:#E91E63;">( Inserts text information - Link, advertisement, etc. )</div>'.format(
    ...
    },
    {
        ...
        "description": '<div style="color:#3F51B5;">{}\r\n{}</div>\r\n<div style="color:#E91E63;">( Accepts likes on geo-objects.  It works only in one selected place - Header, Description or Footer.)</div>'.format(
